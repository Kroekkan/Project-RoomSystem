...
export default function Login () {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-100 flex items-center justify-center p-4 overflow-hidden">

            {/* Main Container */}
            <div className="w-full max-w-6xl min-h-[700px] bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="relative flex items-center justify-center p-8 md:p-12 lg:p-14 overflow-hidden bg-white">
                    ...
                    <div className="relative z-10 w-full max-w-xl">
                        ...
                        <img src="/LogoUdom.jpg" alt="Logo" className="h-40 w-40 object-cover rounded-full"  />
                ...
                {/* ================= RIGHT : LOGIN ================= */}
                <div className="relative flex items-center justify-center bg-slate-50/70 p-6 md:p-10">

                    {/* Login Card */}
                    <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200 shadow-xl">
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center gap-1 mb-3">
                                <div className="w-12 h-12 rounded-2xl bg-sky-50 flex items-center justify-center mb-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="อีเมล"
                                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white border border-sky-100 focus:border-sky-400 focus:ring-2 focus:ring-sky-100 outline-none transition-all placeholder:text-gray-400 text-sm"
                                    required
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="mt-2 w-full py-3 rounded-xl bg-black text-white font-medium shadow-md hover:shadow-lg hover:bg-slate-800 hover:scale-[1.01] active:scale-[0.98] transition-all disabled:opacity-60 disabled:hover:scale-100"
                            >
                                {loading
                                    ? "กำลังเข้าสู่ระบบ..."
                                    : "เข้าสู่ระบบ"}
