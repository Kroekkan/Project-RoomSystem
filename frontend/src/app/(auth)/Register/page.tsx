...
export default function Register () {
    ...
    return (
        <div className="min-h-screen w-full bg-gray-100 flex items-center justify-center p-4 overflow-y-auto lg:h-screen lg:overflow-hidden">
            {/* Main Container */}
            <div className="w-full max-w-6xl min-h-0 lg:min-h-[700px] bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2">
                ...
                {/* ================= RIGHT : REGISTER ================= */}
                <div className="relative flex items-center justify-center bg-slate-50/70 p-4 md:p-6">
